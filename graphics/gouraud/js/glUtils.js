...
function setMatrixUniforms(gContext) {
    ...
    gl.uniformMatrix4fv(mvUniform, false, new Float32Array(gContext.mvMatrix.flatten()));
				...
				gContext.normalMatrix = gContext.mvMatrix.inverse();
				gContext.normalMatrix = gContext.normalMatrix.transpose();
				var nUniform = gl.getUniformLocation(gContext.shaderProgram, "uNormalMatrix");
				gl.uniformMatrix4fv(nUniform, false, new Float32Array(gContext.normalMatrix.flatten()));
}
